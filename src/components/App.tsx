...
export function App(): ReactElement {
  ...
  const [teacherBasicData, setTeacherBasicData] = useState<
    IBasicCourseInfo[] | null
  >(null)
  const [activeCourse, setActiveCourse] = useState<IBasicCourseInfo | null>(
    null
  )
  const [detailedCourse, setDetailedCourse] = useState<IDetailedCourse | null>(
    null
  )
